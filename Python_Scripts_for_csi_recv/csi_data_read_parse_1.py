...
def csi_data_read_parse(port: str, csv_writer, log_file_fd,callback=None):
    ...
    while True:
        ...
        try:
            ...
            continue  # Ή return, αν δεν είναι μέσα σε for loop. Απλά αγνοεί το χαλασμένο πακέτο.
...
if __name__ == '__main__':
    ...
    # --- Δημιουργία μοναδικών ονομάτων με Timestamp ---
    current_time = datetime.now().strftime("%Y%m%d_%H%M%S")
    default_csv = f"./csi_data_espressif_{current_time}.csv"
    default_log = f"./csi_log_espressif_{current_time}.txt"
    ...
    # --- Χρήση των νέων default ονομάτων ---
